        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FileAttachments_Goods_GoodsID",
                        column: x => x.GoodsID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(maxLength: 512, nullable: true),
                    Seq = table.Column<int>(nullable: false),
                    FileAttachmentId = table.Column<Guid>(nullable: false),
                    ParentId = table.Column<Guid>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Category_FileAttachments_FileAttachmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Category_FileAttachmentId",
                table: "Category",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileAttachments_GoodsID",
